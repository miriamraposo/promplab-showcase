...
| **Frontend (React)** | Asynchronous architecture, state machines for long processes, and security via JWT headers. | [📄 frontend_example.jsx](code-excerpts/frontend_example.jsx) |
